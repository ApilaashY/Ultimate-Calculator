...
class OrdinaryAnnuity extends StatefulWidget {
  const OrdinaryAnnuity({super.key});

  @override
  State<OrdinaryAnnuity> createState() => _OrdinaryAnnuityState();
}
...
class _OrdinaryAnnuityState extends State<OrdinaryAnnuity> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ordinary Annuity'),
        foregroundColor:
