...
class _VectorSubtractionState extends State<VectorSubtraction> {
  late List<Widget> subtractionList = [
          ...
          IconButton(
              onPressed: () {
                if (_quantityControllers.length > 1) {
                  subtractionList.removeRange(
                      subtractionList.length - 2, subtractionList.length - 1);
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ...
          subtractionList.add(VectorInput(
                ...
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: ListView.builder(
                      itemCount: subtractionList.length,
                      itemBuilder: ((context, index) {
                        return subtractionList[index];
                      }),
                    ),
                  ),
                ),
